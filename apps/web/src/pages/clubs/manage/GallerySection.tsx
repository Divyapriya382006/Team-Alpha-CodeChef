...
export function GallerySection({ clubId }: GallerySectionProps) {
  ...
  return (
    <div className="surface p-6">
      <h2 className="text-base font-semibold text-white">Gallery Management</h2>
      <p className="text-xs text-slate-500 mt-1">Manage photo uploads and captions showcased on the public profile.</p>
      ...
      {galleryQuery.isLoading ? (
        ...
        <p className="mt-5 text-sm text-slate-500">No gallery images uploaded yet.</p>
      )}
    </div>
  );
}
