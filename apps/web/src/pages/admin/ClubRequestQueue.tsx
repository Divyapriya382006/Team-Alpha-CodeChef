  ...
  return (
    <div className="surface p-4">
      <div className="flex items-start justify-between gap-3">
        <h3 className="text-sm font-semibold text-white">{request.clubName}</h3>
        <RequestStatusBadge status={request.status} />
      </div>
      <p className="mt-2 text-sm text-slate-400">{request.description}</p>
      <dl className="mt-3 space-y-1 text-xs text-slate-500">
        <div>
          <dt className="inline font-medium text-slate-400">Faculty details: </dt>
          <dd className="inline">{request.facultyDetails}</dd>
        </div>
        <div>
          <dt className="inline font-medium text-slate-400">Reason: </dt>
    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <h1 className="mt-1 text-xl font-semibold text-white">Club Requests</h1>
          <p className="text-sm text-slate-500">Approve or reject pending club creation requests.</p>
        </div>
