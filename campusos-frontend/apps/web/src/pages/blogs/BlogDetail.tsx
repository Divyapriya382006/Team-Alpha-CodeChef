  ...
  if (blogQuery.isError) {
    ...
    return (
      <div className="mx-auto max-w-3xl px-4 py-16 text-center">
        <h1 className="text-xl font-semibold">{status === 404 ? "Blog not found" : "Something went wrong"}</h1>
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 animate-fade-in">
      <div className="surface p-6">
        ...
        <div className="mt-5 whitespace-pre-wrap border-t border-slate-800 pt-5 text-sm leading-relaxed text-ink">
          {blog.content}
        </div>
