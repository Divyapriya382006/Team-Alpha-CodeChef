    ...
    <div className="mx-auto max-w-6xl px-4 py-10 animate-fade-in">
      <div className="mb-8 flex flex-col gap-4">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-bold tracking-tight text-white">Blogs</h1>
          <p className="mt-2 text-sm text-slate-500">Stories and write-ups from campus clubs.</p>
        </div>
      ...
      {isError && !isLoading && (
        <div className="surface border-rose-900/50 px-4 py-6 text-center">
          <p className="text-sm text-rose-300">Couldn't load blogs.</p>
