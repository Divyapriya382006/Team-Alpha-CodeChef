  ...
  if (projectQuery.isError) {
    ...
    return (
      <div className="mx-auto max-w-3xl px-4 py-16 text-center">
        <h1 className="text-xl font-semibold">{status === 404 ? "Project not found" : "Something went wrong"}</h1>
    ...
    <div className="mx-auto max-w-3xl px-4 py-8 animate-fade-in">
      <div className="surface p-6">
        ...
        {project.contributors.length > 0 && (
          <div className="mt-4">
            <p className="font-mono text-xs uppercase tracking-wide text-muted">Contributors</p>
            <p className="mt-1 text-sm text-ink">{project.contributors.join(", ")}</p>
          </div>
        )}
