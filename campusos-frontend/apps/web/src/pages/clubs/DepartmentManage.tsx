  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-1 text-xl font-semibold text-white">{department.name}</h1>
      </div>
      ...
      {isClubHead && (
        <div className="surface p-6">
          <h2 className="text-base font-semibold text-white">Department Head</h2>
          <p className="mt-1 text-sm text-slate-500">Must already be a member of this department.</p>
