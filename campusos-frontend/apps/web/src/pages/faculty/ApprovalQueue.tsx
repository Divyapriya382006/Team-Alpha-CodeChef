  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <h1 className="mt-1 text-xl font-semibold text-white">Approval Queue</h1>
        <p className="text-sm text-slate-500">Pending event requests for {coordinatedClub.name}.</p>
      </div>
