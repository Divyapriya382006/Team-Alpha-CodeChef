    ...
    <div className="mx-auto max-w-6xl px-4 py-10 animate-fade-in">
      <div className="mb-8 flex flex-col gap-4">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-bold tracking-tight" style={{color: '#0A0A0A'}}>Events</h1>
          <p className="mt-2 text-sm" style={{color: '#555555'}}>Browse approved events across campus.</p>
        </div>
      ...
      {isError && !isLoading && (
        <div className="surface border-2 border-ink bg-white px-4 py-6 text-center shadow-brutal rounded-none">
          <p className="text-sm font-bold" style={{color: '#FF3B3B'}}>Couldn't load events.</p>
