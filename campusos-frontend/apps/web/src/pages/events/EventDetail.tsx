  ...
  if (eventQuery.isError) {
    ...
    return (
      <div className="mx-auto max-w-3xl px-4 py-16 text-center">
        <h1 className="text-xl font-semibold">{status === 404 ? "Event not found" : "Something went wrong"}</h1>
      ...
      <div className="surface p-6">
        ...
        <dl className="mt-5 grid grid-cols-1 gap-4 border-t border-slate-800 pt-5 text-sm sm:grid-cols-2">
          <div>
            ...
            <dd className="mt-0.5 text-ink">{event.location}</dd>
          </div>
          <div>
            <dt className="font-mono text-xs uppercase tracking-wide text-muted">Type</dt>
            <dd className="mt-0.5 text-ink">{event.type === "PUBLIC" ? "Public" : "Club Exclusive"}</dd>
          </div>
          <div>
            <dt className="font-mono text-xs uppercase tracking-wide text-muted">Starts</dt>
            <dd className="mt-0.5 text-ink">{formatDateTime(event.startTime)}</dd>
          </div>
          <div>
            <dt className="font-mono text-xs uppercase tracking-wide text-muted">Ends</dt>
            <dd className="mt-0.5 text-ink">{formatDateTime(event.endTime)}</dd>
          </div>
          <div>
            <dt className="font-mono text-xs uppercase tracking-wide text-muted">Registered</dt>
